...
import menuWhite from 'assets/images/list.png'
          ...
          >
            <div {...{ className: 'container-fluid' }}>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <a
                        {...{
                          className: ' active customNavLink ',
                          href: '/#',
                        }}
                        aria-current="page"
                      >
                    ...
                    <li
                      {...{
                        className: 'nav-item customDropdown ',
                      }}
                    >
                      <a
                        {...{
                          className: ' dropdown-toggle customNavLink ',
                          href: '/#',
                          id: 'navbarDropdown',
                          role: 'button',
                        }}
                      ...
                      <ul
                        {...{
                          className: 'dropdown-content darkto',
                        }}
                        {...{ id: theme }}
                          ...
                          return (
                            <li {...{ key }}>
                              ...
                              >
                                <p
                                  {...{
                                    className: 'float-start mr-3 item-list',
                                  }}
                                >
                                  {' '}
                                  {item.name}{' '}
                    ...
                    <li {...{ className: 'nav-item' }}>
                      <a
                        {...{
                          className: ' join-community customNavLink ',
                          href: '/#',
                        }}
                      >
                        Join our forum
                ...
                <Col
                  {...{
                    className: 'header-column right-header-column col',
                  }}
                >
                  <ul
                    {...{
                      className: 'navbar-nav ms-auto mb-2 mb-lg-0 float-right',
                    }}
                  >
                    <li
                      {...{
                    ...
                    >
                      <a
                        {...{
                          className: 'customNavLink active',
                          href: '/signup',
                        }}
                        aria-current="page"
                      >
