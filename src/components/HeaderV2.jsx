          ...
          >
            <div {...{ className: 'container-fluid' }}>
              ...
              >
                ...
                <Col
                  {...{
                    className: 'header-column right-header-column',
                  }}
                >
                  <ul
                    {...{
                  ...
                  >
                    <Link text="Home" icon={<AiOutlineHome size={21} />} />
                    <Link text="My Network" icon={<BsPeople size={21} />} />
                    <Link text="Jobs" icon={<CgWorkAlt size={21} />} />
                    <Link text="Chat" icon={<BiMessageDetail size={21} />} />
                    <Link
                      text="Messages"
                    ...
                    <li className="nav-item customDropdown  with-label">
                      ...
                      >
                        ...
                        <p className="item-label mb-0">Sell</p>
                      </a>
                      <ul
                    ...
                    <li className="nav-item customDropdown  with-label">
                      ...
                      >
                        ...
                        <p className="item-label mb-0">My 13RMS</p>
                      </a>
                      <ul
                      ...
                      >
                        ...
                        >
                          <h5 className="font-bold text-base">Account</h5>
                          <a
                        ...
                        >
                          <h5 className="font-bold text-base">Manage</h5>
                          <a
                            className="customDropdownItem account-item"
                            href="/#"
                          >
                    ...
                    <li className="nav-item customDropdown  with-label">
                      ...
                      >
                        ...
                        <p className="item-label mb-0">Business Apps</p>
                      </a>
                      <ul
