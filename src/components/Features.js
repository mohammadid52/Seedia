      ...
      <div {...{ className: FeaturesStyles, style: { paddingTop: '2.5rem', paddingBottom: '4rem' } }}>
        <Row {...{ className: 'justify-content ' + theme }}>
          <Col {...{ md: { size: 2 }, sm: { size: 3 }, className: 'text-center mb-4 mb-md-0' }}>
            <div>
              <img {...{ alt: '', src: color?rocketwhite:rocket, style: { height: '5rem' } }} />
              <p {...{ className: '' }}>
          ...
          <Col {...{ md: { size: 2 }, sm: { size: 3 }, className: 'text-center mb-4 mb-md-0' }}>
            <div>
              <img {...{ alt: '', src: color?peoplewhite:people, style: { height: '5rem' } }} />
              <p {...{ className: '' }}>
              Present yourself extensively on<br />
          ...
          <Col {...{ md: { size: 2 }, sm: { size: 2 }, className: 'text-center mb-4 mb-md-0' }}>
            <div>
              <img {...{ alt: '', src: color?photowhite:photo, style: { height: '5rem' } }} />
              <p {...{ className: '' }}>
          ...
          <Col {...{ md: { size: 2 }, sm: { size: 3 }, className: 'text-center mb-4 mb-md-0' }}>
            <div>
              <img {...{ alt: '', src: color?globewhite:globe, style: { height: '5rem' } }} />
              <p {...{ className: '' }}>
          ...
          <Col {...{ md: { size: 2 }, sm: { size: 3 }, className: 'text-center mb-4 mb-md-0' }}>
            <div>
              <img {...{ alt: '', src: color?badgewhite:badge, style: { height: '5rem' } }} />
              <p {...{ className: '' }}>
          ...
          <Col {...{ md: { size: 2 }, sm: { size: 3 }, className: 'text-center mb-4 mb-md-0' }}>
            <div>
              <img {...{ alt: '', src: color?mobilewhite:mobile, style: { height: '5rem' } }} />
              <p {...{ className: '' }}>
          ...
          <Col {...{ md: { size: 2 }, sm: { size: 2 }, className: 'text-center mb-4 mb-md-0' }}>
            <div>
              <img {...{ alt: '', src: color?protectionwhite:protection, style: { height: '5rem' } }} />
              <p {...{ className: '' }}>
                Worldwide buyer
                <br /> protection
              </p>
          ...
          <Col {...{ md: { size: 2 }, sm: { size: 2 }, className: 'text-center mb-4 mb-md-0' }}>
            <div>
              <img {...{ alt: '', src: color?paySafewhite:paySafe, style: { height: '5rem' } }} />
              <p {...{ className: '' }}>
