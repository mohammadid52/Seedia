...
const Layout = ({
  ...
  return (
    <div className="flex-grow w-full  mx-auto  justify-start max-w-360 items-start lg:flex">
      {/* Left sidebar & main wrapper */}
      <div className="flex-1 min-w-0 xl:flex items-start">
        <div
          className={` border-${
            hideBorders ? 'transparent xl:block hidden' : 'b'
          } dark:border-gray-700 border-gray-200  xl:border-b-0 xl:flex-shrink-0 xl:w-60`}
        >
        ...
        <div className="lg:min-w-0 lg:flex-1">
          <div className="h-full py-0 px-0">
            {/* Start main area*/}
