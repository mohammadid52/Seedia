      ...
      <div>
        <div className="row">
          <div className="left-col-panel flex items-center justify-between col-lg-12 col-sm-12 col-md-6 col">
            <div>
              <img src="/logo.png" alt="" className="profile-img-small" />
            </div>
            <input
              value={postText}
    ...
    <div className="relative">
      <div>
        ...
        >
          ...
          <div
            className="mt-8 content-wrapper flex items-start justify-center space-x-4 mx-auto "
            style={{ maxWidth: '90rem' }}
          >
            {/* 1st col */}
            <div className="first-col px-2">
              <Card>
                <div className="css-169sghn light">
                  ...
                  <div className="profile-details-container my-items light card card-body">
                    <div className="float-left  pl-0 pr-0 col-sm-12 col-lg-12">
                      <div className="">
                        <h6 className="font-semibold text-center">My items</h6>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <Card>
                <div>
                  ...
                  <div className="profile-details-container more-activities light card card-body">
                    <div className="float-left  pl-0 pr-0 col-sm-12 col-lg-12">
                      <div className="">
                        <h6 className="text-base text-center">Discover more</h6>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {/* 5th col */}
            <div>
              <div className="third-col-2 px-2">
                <Card>
                  <div className="css-169sghn light">
                    <div className="profile-details-container card card-body">
                      <div className="float-left text-center pl-0 pr-0 col-sm-12 col-lg-12">
              ...
              <div className="third-col h-auto">
                <SideCard />
                <SideCard />
              </div>
            </div>
