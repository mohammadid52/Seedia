import { fetchRelatedJobs, fetchSearchedJobs } from 'apis/queries'
...
const SearchedJobs = ({ userData }: { userData: IParent }) => {
  ...
  const {
    ...
    isFetched,
  } = useQuery('searched-jobs', () => fetchSearchedJobs(searchQuery), {
    enabled: false,
  })
